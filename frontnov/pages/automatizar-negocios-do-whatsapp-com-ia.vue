<template>
      ...
      <section class="hero-bg min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 py-20 text-center relative z-10">
          <div class="max-w-5xl mx-auto animate-slide-up">
            ...
            <div class="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 mb-8 border border-white/30 shadow-lg gap-3">
    ...
    <!-- Losango amarelo -->
    <path d="M 12 4 L 20 12 L 12 20 L 4 12 Z" fill="#FFDF00" clip-path="url(#circle-br)"/>
    
    <!-- Círculo azul central -->
    <circle cx="12" cy="12" r="4.5" fill="#002776" clip-path="url(#circle-br)"/>
    
    <!-- Faixa branca no círculo azul -->
    <path d="M 8.5 13.5 Q 12 11 15.5 13.5" stroke="white" stroke-width="0.8" fill="none" clip-path="url(#circle-br)"/>
    
    <!-- Estrelas pequenas (simplificadas) -->
    <circle cx="10" cy="10" r="0.3" fill="white" clip-path="url(#circle-br)"/>
    <circle cx="12" cy="9.5" r="0.3" fill="white" clip-path="url(#circle-br)"/>
    <circle cx="14" cy="10" r="0.3" fill="white" clip-path="url(#circle-br)"/>
    <circle cx="11" cy="14" r="0.3" fill="white" clip-path="url(#circle-br)"/>
    <circle cx="13" cy="14" r="0.3" fill="white" clip-path="url(#circle-br)"/>
</svg>
            ...
            <p class="text-xl md:text-3xl text-gray-100 mb-10 max-w-4xl mx-auto leading-relaxed drop-shadow-md">
              Aumente suas vendas até <strong class="text-yellow-400 text-2xl md:text-4xl">7x</strong> com bots inteligentes que respondem como humanos, 
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-10 text-white">
              <div class="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 border border-white/20">
                ...
                <span class="text-lg font-semibold drop-shadow-sm">+200 empresas confiam em nós</span>
              </div>
              <div class="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 border border-white/20">
                <div class="flex text-yellow-400 text-xl">
                  ⭐⭐⭐⭐⭐
                </div>
                <span class="text-lg font-semibold drop-shadow-sm">4.9/5 em avaliações</span>
              </div>
            </div>
          </div>
        </div>
