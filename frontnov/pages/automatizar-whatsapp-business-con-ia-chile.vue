<template>
    ...
    <svg width="24" height="24" viewBox="0 0 24 24" class="flex-shrink-0">
        ...
        <path d="M 0 12 A 12 12 0 0 0 24 12 Z" fill="#D52B1E" clip-path="url(#circle)"/>
        
        <!-- Cuadrado azul superior izquierdo -->
        <path d="M 0 0 L 8 0 L 8 12 L 0 12 A 12 12 0 0 1 0 0" fill="#0039A6" clip-path="url(#circle)"/>
        
        <!-- Estrella blanca -->
        <path d="M 4 6 L 4.5 7.5 L 6 7.5 L 4.8 8.4 L 5.3 9.9 L 4 9 L 2.7 9.9 L 3.2 8.4 L 2 7.5 L 3.5 7.5 Z" fill="white"/>
    </svg> <span class="text-white text-sm font-semibold drop-shadow-sm"> Nuevo: IA Conversacional Avanzada 🚀 </span>
            </div>
